;;;; common-list.scm --- COMMON LISP list functions for ERR5RS Scheme
;;;;
;;;; Port from guile to ERR5RS by Leonardo Valeri Manera
;;;;
...
(library (err5rs getopt-long)
	 ...
	 (import (rnrs base) (rnrs lists) (larceny load)))
(require 'srfi-1)
